...
| Three governance profiles | Normal remains fast; enterprise adds controls; government adds IL6/IL7-minded evidence. | Competitor forces one policy model for all users or makes personal mode unusable. | Keep profile docs and tests that prove normal mode remains low-friction. |
