...
| system-dashboard | `C:\Users\techai\system-dashboard` | `master` | `d551d4b` | pushed, CI PASS, fleet guard + BPC/TSK governance controls; generated DB untracked | `https://github.com/rblake2320/system-dashboard.git` |
...
- `system-dashboard` at `d551d4b`: GitHub Actions run `27913217334` PASS.
  ...
  with repo-local temp storage: `128 passed`. The generated SQLite dashboard DB
